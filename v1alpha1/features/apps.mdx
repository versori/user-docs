...
<CardGroup cols={1}>
    <Card title="REST API" href="/v1alpha1/how-to-guides/apps/onboarding-apps/rest-api">
    ...
    <Card title="GraphQL API" href="/v1alpha1/how-to-guides/apps/onboarding-apps/graphql-api">
    ...
    <Card title="SQL Database" href="/v1alpha1/how-to-guides/apps/onboarding-apps/sql-app">
