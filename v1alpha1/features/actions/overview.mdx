...
<CardGroup cols={2}>
    <Card title="Transformer" icon="shuffle" href="/v1alpha1/features/actions/transformer">
    ...
    <Card title="Filter" icon="filter" href="/v1alpha1/features/actions/filter">
    ...
    <Card title="Datamapper" icon="arrow-up-arrow-down" href="/v1alpha1/features/actions/datamapper">
    ...
    <Card title="Splitter" icon="merge" href="/v1alpha1/features/actions/splitter">
    ...
    <Card title="Databuilder" icon="align-left" href="/v1alpha1/features/actions/databuilder">
    ...
    <Card title="Batch" icon="layer-group" href="/v1alpha1/features/actions/batch">
        The batch action allows you to gather requests over a period of time and combine them into a single request.
    </Card>
    <Card title="Delay" icon="clock" href="/v1alpha1/features/actions/delay">
        Delay can be used to delay the execution of the next action in your workflow.
    </Card>
    <Card title="Trigger" icon="play" href="/v1alpha1/features/actions/trigger">
