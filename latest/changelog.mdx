...
<Update label="26th August 2026" description="2026.08.26">
    ...
    - Issue Watcher is here — a new project tab that lets you watch for issues and hand them to an AI agent, which investigates and proposes a fix for you to review before it's applied. Set up agent channels for your organisation from Account > Cloud Agents, then link them to your integrations from the Issues tab with filters for which issues they should watch.
