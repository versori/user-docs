...
<Update label="16th September 2026" description="2026.09.16">
    ...
    - Fixed an issue in the Build chat where generating large files could cause high memory usage and a sluggish editor, since file content was streamed into the code editor character by character. File contents are now applied in a single step once ready, keeping the workspace responsive during generation.
