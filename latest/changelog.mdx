...
<Update label="09th September 2026" description="2026.09.09">
    ...
    - **Skills marketplace.** Browse a catalogue of ready-made skills and add them to your organisation, instead of
      ...
      suggest a relevant skill while you work — nothing is added unless you approve it. See the
    ...
    - **Skills have moved to their own page.** Your organisation's skills are now under **Skills** in the left-hand
      navigation, rather than in organisation settings, with search, filtering by enabled status, and bulk actions.
    ...
    - Skills now apply across your whole organisation, so there is no longer a per-integration step to attach them.
      Mark a skill as mandatory to apply it to every request, or leave it to be loaded when its description matches
      the work in hand. See [How the AI applies skills](/latest/ai-tooling/skills#how-the-ai-applies-skills).
