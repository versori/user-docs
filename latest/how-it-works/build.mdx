...
<Note>
The Build Agent now lives inside the [unified agent chat](/latest/guides/getting-started/unified-chat), alongside the Plan Agent. Select **Build** mode in the chat composer to implement your integration, and switch to **Plan** in the same conversation whenever you need to research or refine the scope.
</Note>
...
See [The Unified Chat guide](/latest/guides/getting-started/unified-chat) for how the combined conversation works.
