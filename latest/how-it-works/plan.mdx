...
<Note>
The Plan Agent now lives inside the [unified agent chat](/latest/guides/getting-started/unified-chat), alongside the Build Agent. Select **Plan** mode in the chat composer to research and scope your integration, then switch to **Build** in the same conversation when you're ready to implement. All documents the Plan Agent produces are saved as files in your project's `documents/` folder.
</Note>
