...
1. The [Versori CLI installed](/latest/cli/installation) (v0.4.0 or later)
2. An authenticated CLI context — see the [Quickstart](/latest/cli/quickstart) guide
3. A Versori project — create one with `versori projects create --name my-project`
...
<Steps>
    <Step title="Install the plugin">
        ...
        You can also discover and install it from the [Claude Code plugin marketplace](https://platform.claude.com/plugins).
    </Step>
