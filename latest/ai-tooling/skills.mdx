...
{/* TODO screenshot: images/ai-tooling/skill-detail.png
    Capture: a skill open on the Skills page, showing its SKILL.md alongside its resource files in the file tree, so the bundle shape is concrete.
    Alt: "A skill open in Versori, showing SKILL.md and its resource files"
...
never be missed, such as compliance requirements, and keep those skills short.
