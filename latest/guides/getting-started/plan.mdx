...
planning agent handles your message. See [The Unified Chat](./unified-chat) for how the combined conversation works.
...
Our [Build](/latest/guides/getting-started/build) guide covers building and its capabilities.
