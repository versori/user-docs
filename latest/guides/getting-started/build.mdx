...
<Note>
Bulding now takes place inside the [unified agent chat](/latest/guides/getting-started/unified-chat), alongside the Plan. Select **Build** mode in the chat composer to implement your integration, and switch to **Plan** in the same conversation whenever you need to research or refine the scope.
</Note>
...
the coding agent handle your next message. See [The Unified Chat](./unified-chat) for how the combined conversation works.
...
- **Self-prompting**: You define the integration requirements and prompt the agent directly with the toggle set to
  **Build**.
- **Workflow-driven prompting**: You follow on from [planning](./plan) and workflow generation carried out earlier in
  the same chat.
...
If you have carried out research and generated workflows during [planning](./plan), those workflows appear as cards
...
<img src="/images/guides/build/multiple-chats-001.png" alt="The chat history panel showing multiple chat sessions" />
</Frame>
