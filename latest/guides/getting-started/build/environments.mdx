...
- **Iterate faster**: Debug issues and refine workflows in a development environment where mistakes have no downstream
  consequences.
- **Control promotion**: Move changes through a structured path — for example, development to staging to production —
  so each release is verified before it reaches live systems.
...
<Tip>
Start with at least two environments — one for development and one for production. This gives you a safe space to build
