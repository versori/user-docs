...
description: "Get the most out of AI-assisted integration development with the Versori skill."
weight: 5
---
...
- **[Workflows & triggers](/run-sdk/workflows/)** — webhook and schedule-based entry points for integrations
- **[Task types](/run-sdk/workflows/task-types/)** — the building blocks of workflows: functions, HTTP calls, and more
- **[Context & KV storage](/run-sdk/context/)** — how workflows access connections, logging, and persistent state
- **[Durable workflows](/run-sdk/durable-workflows/)** — long-running workflows with persistent state across executions

## Common integration patterns

The skill handles a variety of integration patterns. These guides cover common use cases in detail:

- [Real-time integrations](/user-guide/use-cases/real-time/) — event-driven workflows triggered by webhooks
- [Batch integrations](/user-guide/use-cases/batch/) — scheduled data synchronisation between systems
- [Bidirectional sync](/user-guide/use-cases/bidirectional/) — two-way data flow between systems
- [Multi-tenancy](/user-guide/use-cases/multi-tenancy/) — integrations that support multiple end users
