---
title: "Workflow"
description: "The structured 8-step process the Versori skill follows to build integrations."
weight: 4
---
...
2. **Research**
   ...
   This mirrors what the [Plan agent](/how-it-works/plan/) does in the Versori platform UI.
...
4. **Connection Creation**
   ...
   See the [Connections guide](/cli/connections/) for details on authentication methods and connection configuration.

5. **Code Generation**

   The agent generates TypeScript workflows using the [Versori Run SDK](/run-sdk/introduction/). It writes workflow files that:
...
8. **Deployment**
   ...
   See the [Project Workflow guide](/cli/workflow/) for details on deployment, versioning, and monitoring.
{{% /steps %}}
...
- [Plan agent](/how-it-works/plan/) — how Versori researches integrations
- [Connections guide](/cli/connections/) — managing authenticated connections
- [Run SDK](/run-sdk/introduction/) — the SDK used to build workflows
- [Project Workflow](/cli/workflow/) — CLI-based project lifecycle
