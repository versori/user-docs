...
> [Durable Workflows](/run-sdk/durable-workflows/) page. Workflows in this context are not a public
...
As covered in the [Introduction](/run-sdk/introduction/), a workflow is declared by calling the `webhook`
...
> [Context](/run-sdk/context/) object just like the Promise API.
>
