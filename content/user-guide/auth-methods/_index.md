...
in full control of the integration code, it's recommended to utlise Versori's [Run SDK](/run-sdk/) to interact
...
> code). See the [Run SDK](/run-sdk/context/) guide for more details on how to achieve this.
...
- [Authorization Code](/user-guide/auth-methods/methods/oauth2/authorization-code/)
- [Client Credentials](/user-guide/auth-methods/methods/oauth2/client-credentials/)
- [Password/Resource Owner](/user-guide/auth-methods/methods/oauth2/password-resource-owner/)
- [Refresh Token](/user-guide/auth-methods/methods/oauth2/refresh-token/)

See our [OAuth 2.0](/user-guide/auth-methods/methods/oauth2/) guide for more details on how to configure each of these grant
types.
