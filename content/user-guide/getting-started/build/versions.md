...
{{% steps %}}
1. **Open the Version History popover**

   Navigate to your project and select the **Version History** popover in the header.

   {{< image src="/images/guides/build/version-history-001.png" alt="Version History popover showing a list of versions with their status, date, and description" >}}
...
2. **Create a new version**
   ...
   {{< image src="/images/guides/build/version-create-001.png" alt="Create New Version dialog with fields for version name and description" >}}
...
{{< image src="/images/guides/build/version-deploy-001.png" alt="Deploy Latest Draft to production dialog showing version name, description, and the latest version number" >}}
...
{{% steps %}}
1. **Choose the version to deploy**
...
> [!TIP]
> Combine versions with [environments](/user-guide/getting-started/build/environments/) to build a robust promotion
