...
{{< image src="/images/guides/chat/unified-chat-001.png" alt="The chat panel showing planning and build turns in a single conversation" >}}
...
{{< image src="/images/guides/chat/plan-build-toggle-001.png" alt="The Plan/Build toggle next to the chat send button" >}}
...
{{< image src="/images/guides/chat/workflow-card-build-001.png" alt="A planned workflow card with a Build button" >}}
...
{{< image src="/images/guides/chat/chat-history-001.png" alt="The chat history panel listing past conversations with kind labels" >}}
...
[Managing multiple chats](/user-guide/getting-started/build/#managing-multiple-chats) for guidance on when to start fresh.
...
- Learn what the planning agent researches and produces in [Starting your plan](/user-guide/getting-started/plan/).
- See how to implement, test, and iterate on workflows in [Building your integration](/user-guide/getting-started/build/).
