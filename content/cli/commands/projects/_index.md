...
See the [activations reference](/cli/commands/projects/activations/) for detailed subcommands to manage activations (end-user → environment links). alias for the activation-lifecycle commands under `versori projects users`.
...
See the [asset reference](/cli/commands/projects/asset/) for detailed subcommands to manage assets within a project.
...
See the [environments reference](/cli/commands/projects/environments/) for detailed subcommands to manage project environments.
...
See the [systems reference](/cli/commands/projects/systems/) for detailed subcommands to manage systems within a project.
...
See the [users reference](/cli/commands/projects/users/) for detailed subcommands to manage users (activations) within a project.
...
See the [variables reference](/cli/commands/projects/variables/) for detailed subcommands to manage a project's dynamicvariablesschema (declares valid activation-variable keys).
...
See the [versions reference](/cli/commands/projects/versions/) for detailed subcommands to manage versions within a project.
