...
<CardGroup cols={1}>
  <Card title="REST API" href="/features/app-types/rest-api">
  ...
  <Card title="GraphQL API" href="/features/app-types/graphql-api">
  ...
  <Card title="SQL Database" href="/features/app-type/sql-app">
