...
<CardGroup cols={1}>
  <Card title="REST API" href="/how-to-guides/onboarding-apps/rest-api">
  ...
  <Card title="GraphQL API" href="/how-to-guides/onboarding-apps/graphql-api">
  ...
  <Card title="SQL Database" href="/how-to-guides/onboarding-apps/sql-app">
