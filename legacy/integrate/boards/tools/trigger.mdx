---
title: 'Trigger'
description: 'The Trigger is used to trigger an action on a schedule.'
---

A Trigger allows you to schedule automated actions with precise timing and frequency controls. You can set when the
action starts, how often it repeats, and on which days it should run.
...
- **Frequency** - The frequency of the schedule. For example, if you choose "2" and "Hours", the schedule will run twice
  every hour.
