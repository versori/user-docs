...
- [Definition](./connectors/definitions) - defines the data structures used by the action or trigger. For example, HTTP
  actions and triggers may contain definitions for each of the request and response bodies. Versori supports definitions
  in JSON Schema or XSD.
