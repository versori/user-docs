...
recommended to learn more about [how Versori Embedded works](/legacy/embedded/how-it-works) before choosing your
implementation method.

## Implementation Methods

<CardGroup cols={3}>
    <Card title="Embedded API" icon="microchip" href="/legacy/api-reference/embedded">
        Use our Embedded API for full control over your integration hub.
    </Card>
    <Card title="TypeScript SDK" icon="code" href="/legacy/embedded/sdks/typescript">
        Use our TypeScript SDK for building your integration hub quickly and easily.
    </Card>
    <Card title="React SDK" icon="react" href="/legacy/embedded/sdks/react">
