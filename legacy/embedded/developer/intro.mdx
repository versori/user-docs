...
[api-keys]: /legacy/api-reference/authentication#api-keys
[get-end-user]: /legacy/api-reference/embedded-api/end-users/retrieve-an-end-user
[list-end-user-integrations]: /legacy/api-reference/embedded-api/embedded/list-end-user-integrations
[create-end-user]: /legacy/api-reference/embedded-api/end-users/create-an-end-user
[activate-integration]: /legacy/api-reference/embedded-api/activations/activate-integration
