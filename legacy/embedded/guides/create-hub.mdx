...
#api: 'POST https://platform.versori.com/api/embedded/legacy/hubs'
---
...
If your Connector contains multiple [Authentication Methods](/legacy/concepts/connectors/authentication-methods), you'll
be prompted to choose which method should be used by your End Users when connecting to your application.
