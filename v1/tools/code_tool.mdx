...
It also offers the ability to write a custom output schema, which can be useful to reshape the data for later on in an integration.'
---
...
- **Note** - the board must currently be published to test the code within the Code Tool {/* Add link on how to publish a board */}
