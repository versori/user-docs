...
<Warning>
    ...
    [Apps](/v1alpha1/features/apps). Specific documentation can be found at [Onboard a GraphQL
    API](/v1alpha1/how-to-guides/apps/onboarding-apps/graphql-api).
</Warning>
...
<Warning>
    ...
    [Apps](/v1alpha1/features/apps) functionality.
</Warning>
