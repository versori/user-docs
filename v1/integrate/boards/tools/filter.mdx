...
Using selectors to access data from any previous step in the workflow, any kind of business logic can be applied to the
data flowing through the Integration.
